({
    getAccountDetail: function(component, event) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state == "SUCCESS") {
                component.set("v.accInfo", resInfo.AccountInfo);
                component.set("v.accInfo.EbizC__EBizCharge_Internal_ID__c", resInfo.AccountInternalId);
            } 
            else {
    ...
    deletePaymentMethod: function(component, event) {
        ...
        action.setParams({
            "accId": component.get('v.accInfo.Id'),
            "internalId": component.get('v.accInfo.Ebiz_C__EBizCharge_Internal_ID__c'),
    ...
    updatePaymentMethod: function(component, event) {
        ...
        if (SelectedTab == 'CreditCard') {
            ...
            strUpd.AccountId = component.get('v.accInfo.Id');
            strUpd.AccInternalId = component.get('v.accInfo.Ebiz_C__EBizCharge_Internal_ID__c');
            ...
            strUpd.MethodName = component.get('v.accountNickName');
            strUpd.AccountHolderName = component.get('v.accountHolderName');
            strUpd.Account = component.get('v.accInfo.DDA_Enc__c');
            strUpd.AccountType = component.get('v.accInfo.DDA_Type__c');
            strUpd.Routing = component.get('v.accInfo.ABA__c');
    ...
    addPaymentMethod: function(component, event) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state == "SUCCESS") {
                ...
                if(error.length > 0){
                component.set('v.Spinner', false);
                let errorMessage = (error.length > 0 ? error[0].message : (typeof error.message != undefined && (error.message != '' || error.message != null) ? error.message : (typeof error != undefined && typeof error.body.message != undefined ? error.body.message : 'Please refresh the page')));
