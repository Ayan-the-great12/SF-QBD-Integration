    ...
    onChangeAmount: function(component, evt, helper) {
        ...
        if (obj == 'Quote') {
            ...
            if (amount > QuoteBalance) {
                ...
                helper.showToast('Amount should be equal or less than quote remaining amount', 'Warning');
            }
        } else if (obj == 'Order') {
            ...
            if (amount > OrderBalance) {
                ...
                helper.showToast('Amount should be equal or less than order remaining amount', 'Warning');
            }
        }
